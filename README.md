# Welcome to FrogBoiz Arts

All the code in these repos was created and explained by FrogBoiz on the main github channel.

# FrogBoiz Art Engine 🔥

Create generative art & metadata by using the canvas api and node js. Before you use the generation engine, make sure you have node.js installed.
...
```sh
git clone https://github.com/Frogboiz_art/Frogboiz_art.git
```
